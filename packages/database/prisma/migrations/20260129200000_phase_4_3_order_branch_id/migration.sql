-- Phase 4.3: Drop order contour and recreate with Order.branchId NOT NULL (FK Branch).
-- OrderLine keeps variantId only (offerId in Phase 4.4).
...
-- 2. Create Order with branchId NOT NULL
CREATE TABLE "Order" (
    "id" TEXT NOT NULL,
    "token" TEXT NOT NULL,
...
-- 3. OrderLine (Phase 3.1, same structure; variantId only)
